 ...
 */
public class DaoEmpresa {public static boolean inserir(Empresa objeto) {
    ...
    public static void main(String[] args) {
        ...
        objeto.setNomefantasia("Black");
        objeto.setRazaosocial("Brasileiros");
  ...
  public static List<Empresa> consultar() {
   ...
   public static Empresa consultar(int primaryKey) {
        //editar o SQL conforme a entidade
        String sql = "SELECT codigo, nomefantasia, razaosocial FROM produto WHERE codigo=?";
        PreparedStatement ps;
        try {
            ps = conexao.Conexao.getConexao().prepareStatement(sql);
            ...
            while (rs.next()) {
                ...
                //definir um set para cada atributo da entidade, cuidado com o tipo
                objeto.setCodigo(rs.getInt("codigo"));
                objeto.setNomefantasia(rs.getString("Nome da Fantasia"));
                objeto.setRazaosocial(rs.getString("Razão Social"));
