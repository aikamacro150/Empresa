...
public class ControladorEmpresa {
    public static void inserir(ManutencaoEmpresa man){
        ...
        objeto.setNomefantasia(man.jtfNomedaFantasia.getText());
        objeto.setRazaosocial(man.jtfRazaoSocial.getText());
        
        boolean resultado = DaoEmpresa.inserir(objeto);
        if (resultado) {
            JOptionPane.showMessageDialog(null, "Inserido com sucesso!");if (man.listagem != null) {
     atualizarTabela(man.listagem.tabela); //atualizar a tabela da listagem
}
man.dispose();
        } else {//fechar a tela da manutenção
...
public static void excluir(ManutencaoEmpresa man){
      Empresa objeto = new Empresa();
        ...
        if (resultado) {
            JOptionPane.showMessageDialog(null, "Excluído com sucesso!");if (man.listagem != null) {
     atualizarTabela(man.listagem.tabela); //atualizar a tabela da listagem
}
man.dispose();
        } else {//fechar a tela da manutenção
...
public static void atualizarTabela(JTable tabela) {
        ...
        modelo.addColumn("Nome da Fantasia");
...
public static void atualizaCampos(ManutencaoEmpresa man, int pk){ 
        ...
        man.jtfNomedaFantasia.setText(objeto.getNomefantasia());
